...
class Dftb2(Calculator):
    ...
    def forces(self):
        ...
        gamma_grad = gamma_exponential_gradient(self.geometry, self.orbs, self.u_feed.forward(self.orbs)) #TODO change self.u_feed(self.orbs) to self.u_feed.forward(self.orbs)
