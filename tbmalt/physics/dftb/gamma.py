...
def build_gamma_matrix(
        geometry: Geometry, basis: Basis, hubbard_Us: Tensor,
        scheme: Literal['exponential', 'gaussian'] = 'exponential'):
    ...
    if geometry.cells is not None:
        raise NotImplementedError(
            'Gamma construction does not yet support periodic systems')
